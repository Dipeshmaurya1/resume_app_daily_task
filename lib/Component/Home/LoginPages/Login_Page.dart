        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Text('Welcome Back ,',style: TextStyle(color: Colors.black,fontSize: 32,fontWeight: FontWeight.bold),),
              const Text('Make it work , Make it right,Make it fast',style: TextStyle(color: Colors.black,fontSize: 14,),),
              ...
              Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        child: Image.asset('Assets/Image/google.jpeg',height: 25,width: 25,),
                      ),
                      SizedBox(width: 20,),
